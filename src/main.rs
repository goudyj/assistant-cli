...
async fn main() {
    ...
    let project_name_arg = args.iter()
    ...
    match github.list_issues_paginated(&[], &IssueState::Open, 20, 1).await {
...
// ============================================================================
// Legacy REPL functions (kept for reference, to be removed after validation)
// ============================================================================

#[allow(dead_code)]
async fn run_legacy_repl() {
    dotenvy::dotenv().ok();
